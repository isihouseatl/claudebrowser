...
class Claudebrowser < Formula
  ...
  on_arm do
    url "https://github.com/isihouseatl/claudebrowser/releases/download/v1.0.0/claudebrowser-macos-arm64"
    sha256 "d18d3fd9ac8e016d7753a80cbceb9f4ea0d47ca0c99998d2074cd93b48fd7035"
  end

  on_intel do
    url "https://github.com/isihouseatl/claudebrowser/releases/download/v1.0.0/claudebrowser-macos-x64"
